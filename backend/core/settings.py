...
JWT_ACCESS_MINUTES = int(os.getenv('JWT_ACCESS_LIFETIME', os.getenv('JWT_ACCESS_MINUTES', 480)))  # 8 hours
JWT_REFRESH_MINUTES = int(os.getenv('JWT_REFRESH_LIFETIME', os.getenv('JWT_REFRESH_MINUTES', 10080)))  # 7 days
SIMPLE_JWT = {
