...
type MobileDrawerFormProps = {
  ...
  onSubmit?: (e: React.FormEvent) => void; // ✅ YANGI PROP
};
 ...
 * - ✅ FIXED: Form wrapper added to enable submit buttons in footer
 */
const MobileDrawerForm = ({
  ...
  return (
    ...
    >
      {/* ✅ FORM WRAPPER - Butun drawer'ni o'raydi */}
      <form 
      ...
      >
        ...
        <div className="flex items-center justify-between border-b border-slate-200 bg-white px-4 py-4 dark:border-slate-800 dark:bg-slate-900">
          ...
          <button
            type="button" // ✅ type="button" - formni submit qilmaydi
            onClick={onClose}
